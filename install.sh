...
: ${BINARY_NAME:="kformpkg"}
: ${PROJECT_NAME:="kformpkg"} # if project name does not match binary name
: ${USE_SUDO:="true"}
...
: ${REPO_NAME:="kform-tools/kformpkg"}
: ${REPO_URL:="https://github.com/$REPO_NAME"}
: ${PROJECT_URL:="https://docs.kform-tools.dev"}
